...
export type SharedEnv = {
  ...
  STRIPE_PRICE_TOPUP_250?: string;
  STRIPE_PRICE_TOPUP_750?: string;
  STRIPE_PRICE_TOPUP_2500?: string;
  // Webhook security
...
export function getEnv(): SharedEnv {
  ...
  return {
    ...
    STRIPE_PRICE_TOPUP_100:   env.STRIPE_PRICE_TOPUP_100,
    STRIPE_PRICE_TOPUP_500:   env.STRIPE_PRICE_TOPUP_500,
...
/** No-op — kept for backwards compatibility. Safe to call, does nothing. */
