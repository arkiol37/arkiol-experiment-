  ...
  return (
    <div className="ak-fade-in" style={{ padding: "36px 44px", maxWidth: 1200 }}>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ margin: 0, fontSize: 28, fontWeight: 800, fontFamily: "var(--font-display)", letterSpacing: "-0.045em" }}>
          Campaigns & Jobs
        </h1>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: "center", padding: "52px 24px", background: "var(--bg-elevated)", borderRadius: "var(--radius-2xl)", border: "1px dashed var(--border-strong)" }}>
          ...
          <h3 style={{ fontSize: 16, fontWeight: 700, fontFamily: "var(--font-display)", margin: "0 0 6px" }}>No jobs found</h3>
