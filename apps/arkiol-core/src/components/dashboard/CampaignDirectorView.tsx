...
export function CampaignDirectorView() {
  ...
  return (
    <div className="ak-fade-in" style={{ padding: "32px 40px", maxWidth: 960 }}>
      ...
      {error && (
        <div style={{ marginBottom: 16, padding: "10px 14px", background: "color-mix(in srgb, var(--error) 10%, var(--surface))", borderRadius: 8 }}>
      ...
      {plan && (
        <>
          ...
          <div className="ak-card" style={{ padding: "16px 20px", marginBottom: 16 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
              {[
                ...
                <div key={f.label} style={{ background: "var(--surface-raised)", borderRadius: 6, padding: "6px 10px" }}>
            ...
            <div style={{ marginTop: 12, padding: "8px 10px", background: "var(--surface-raised)", borderRadius: 6 }}>
          ...
          {/* Queue all button */}
          {queueDone ? (
            <div style={{ padding: "12px 16px", background: "color-mix(in srgb, var(--success) 10%, var(--surface))", borderRadius: 8 }}>
