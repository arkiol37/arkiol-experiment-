  ...
  return (
    <div style={{ padding: "36px 44px", maxWidth: 1300, fontFamily: "var(--font-body)" }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 32 }}>
        <div>
          <h1 style={{ margin: 0, fontSize: 28, fontWeight: 400, fontFamily: "var(--font-display)", letterSpacing: "-0.045em", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14, position: "sticky", top: 20 }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: 4 }}>
                <span style={{ fontSize: 26, fontWeight: 400, fontFamily: "var(--font-display)", color: "var(--accent-light)", letterSpacing: "-0.05em" }}>{creditCost}</span>
        ...
        <div>
          ...
          {loadingLib ? (
            ...
            <div style={{ textAlign: "center", padding: "60px 24px", background: "var(--bg-elevated)", borderRadius: "var(--radius-2xl)", border: "1px dashed var(--border-strong)" }}>
              ...
              <h3 style={{ fontSize: 18, fontWeight: 400, fontFamily: "var(--font-display)", margin: "0 0 8px", letterSpacing: "-0.04em" }}>No GIFs yet</h3>
