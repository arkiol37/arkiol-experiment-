  ...
  return (
    <div className="ak-fade-in" style={{ padding: "36px 44px", maxWidth: 1200 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 36 }}>
        <div>
          <h1 style={{ margin: 0, fontSize: 28, fontWeight: 800, fontFamily: "var(--font-display)", letterSpacing: "-0.045em" }}>Brand Kit</h1>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: "center", padding: "60px 24px", background: "var(--bg-elevated)", borderRadius: "var(--radius-2xl)", border: "1px dashed var(--border-strong)" }}>
          ...
          <h3 style={{ fontSize: 18, fontWeight: 800, fontFamily: "var(--font-display)", margin: "0 0 8px", letterSpacing: "-0.04em" }}>No brand kit yet</h3>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          ...
          <div className="ak-card ak-card-elevated" style={{ padding: 24 }}>
            ...
            <div style={{ borderRadius: "var(--radius-lg)", overflow: "hidden", border: "1px solid var(--border)", marginTop: 8 }}>
              <div style={{ height: 52, background: `linear-gradient(135deg, ${form.primaryColor ?? "#7c7ffa"}, ${form.secondaryColor ?? "#c084fc"})`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontWeight: 700, color: "#fff", fontFamily: "var(--font-display)", letterSpacing: "-0.03em" }}>
