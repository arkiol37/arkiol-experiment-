  ...
  return (
    <div className="ak-fade-in" style={{ padding: "36px 44px", maxWidth: 1100 }}>
      <div style={{ marginBottom: 32 }}>
        <h1 style={{ margin: 0, fontSize: 28, fontWeight: 800, fontFamily: "var(--font-display)", letterSpacing: "-0.045em" }}>Arkiol Design</h1>
                ...
                <div>
                  ...
                  {result.adCopy.map((ad, i) => (
                    <div key={i} style={{ background: "var(--bg-input)", border: "1px solid var(--border)", borderRadius: "var(--radius-lg)", padding: "16px 18px", marginBottom: 12 }}>
                      ...
                      <div style={{ fontSize: 14, fontWeight: 700, fontFamily: "var(--font-display)", color: "var(--text-primary)", marginBottom: 6, letterSpacing: "-0.03em" }}>{ad.headline}</div>
