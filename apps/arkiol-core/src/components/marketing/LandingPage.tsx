  ...
  return (
    <svg width={size} height={size} viewBox="0 0 52 52" fill="none">
      <defs>
        ...
        <linearGradient id={`${id}sp`} x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#c4b5fd"/><stop offset="100%" stopColor="#14B8A6"/></linearGradient>
...
function Icon3DImageStudio({ size=40 }: { size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 52 52" fill="none">
      <defs>
        <linearGradient id={`${id}fr`} x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#a855f7"/><stop offset="50%" stopColor="#0F766E"/><stop offset="100%" stopColor="#5b21b6"/></linearGradient>
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 52 52" fill="none">
      <defs>
        ...
        <linearGradient id={`${id}c6`} x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#2DD4BF"/><stop offset="100%" stopColor="#0F766E"/></linearGradient>
...
function Icon3DBrain({ size=40 }: { size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 52 52" fill="none">
      <defs>
        <linearGradient id={`${id}r`} x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#c4b5fd"/><stop offset="40%" stopColor="#14B8A6"/><stop offset="100%" stopColor="#5b21b6"/></linearGradient>
        <linearGradient id={`${id}l`} x1="100%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#2DD4BF"/><stop offset="100%" stopColor="#6d28d9"/></linearGradient>
      ...
      <g filter={`url(#${id}dr)`}>
        ...
        <path d="M22 41 Q26 44 30 41" stroke="#14B8A6" strokeWidth="3" strokeLinecap="round" fill="none" opacity="0.75"/>
