...
const WELLNESS_PACK: CategoryStylePack = {
  ...
  preferredThemeIds: ["wellness_meadow", "sage_wellness", "lavender_dream", "peach_bliss", "floral_romance", "script_elegance"],
  paletteMood: "muted",
...
const MOTIVATION_PACK: CategoryStylePack = {
  ...
  preferredThemeIds: ["vintage_paper", "golden_hour", "power_black", "dark_luxe", "cosmic_purple"],
  paletteMood: "dark",
