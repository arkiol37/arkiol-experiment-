...
const WELLNESS_PACK: CategoryStylePack = {
  ...
  preferredThemeIds: ["wellness_meadow", "sage_wellness", "lavender_dream", "peach_bliss", "floral_romance", "script_elegance", "heart_health"],
  paletteMood: "muted",
  ...
  headlineWeight: 300,
  preferredBgKinds: ["linear_gradient", "solid", "scene"],
  accentIntensity: "subtle",
  ctaRadiusBias: "pill",
...
const EDUCATION_PACK: CategoryStylePack = {
  ...
  preferredThemeIds: ["sky_fresh", "lavender_dream", "clean_minimal", "navy_pro", "scrapbook_pop"],
  paletteMood: "light",
...
const BEAUTY_PACK: CategoryStylePack = {
  ...
  preferredThemeIds: ["floral_romance", "peach_bliss", "lavender_dream", "clean_minimal", "style_photo"],
  paletteMood: "warm",
...
const FITNESS_PACK: CategoryStylePack = {
  ...
  preferredThemeIds: ["tropical_jungle", "vibrant_burst", "power_black", "coral_energy", "sunset_warm"],
  paletteMood: "vibrant",
  ...
  headlineLetterSpacing: 0.02,
  headlineWeight: 900,
  preferredBgKinds: ["scene", "mesh", "linear_gradient", "solid"],
...
const TRAVEL_PACK: CategoryStylePack = {
  ...
  preferredThemeIds: ["travel_vista", "ocean_blue", "tropical_paradise", "sky_fresh", "sunset_warm"],
  paletteMood: "vibrant",
  ...
  headlineLetterSpacing: -0.02,
  headlineWeight: 700,
  preferredBgKinds: ["scene", "linear_gradient", "mesh"],
  accentIntensity: "moderate",
  ctaRadiusBias: "pill",
  compositionBias: "hero",
  spacingDensity: "balanced",
...
const MOTIVATION_PACK: CategoryStylePack = {
  ...
  preferredThemeIds: ["vintage_paper", "golden_hour", "power_black", "dark_luxe", "cosmic_purple", "scrapbook_pop"],
  paletteMood: "dark",
...
const FOOD_PACK: CategoryStylePack = {
  ...
  preferredThemeIds: ["tropical_jungle", "sunset_warm", "earth_coffee", "peach_bliss", "vibrant_burst"],
  paletteMood: "warm",
