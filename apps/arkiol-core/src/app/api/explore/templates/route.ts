...
const TEMPLATES = [
  ...
  { id: "t2",  title: "Tech Product Launch",  category: "Marketing", format: "Poster",         emoji: "⚡", accent: "#818cf8", prompt: "Modern tech product launch poster with dark background and electric neon blue accents" },
  ...
  { id: "t10", title: "Course Promo",         category: "Marketing", format: "YouTube Thumb",  emoji: "📚", accent: "#818cf8", prompt: "Educational course YouTube thumbnail — clean, professional, bright colors, text overlay" },
  ...
  { id: "t16", title: "Startup Logo",         category: "Brand",     format: "Logo",           emoji: "🚀", accent: "#818cf8", prompt: "Modern startup logo with abstract rocket motif, gradient from indigo to violet, minimal" },
  ...
  { id: "t18", title: "App Store Banner",     category: "Marketing", format: "Banner",         emoji: "📲", accent: "#818cf8", prompt: "Clean app store feature banner — iOS style, gradient background, device mockup, bold headline" },
