...
const TEMPLATES = [
  { id: "t1",  title: "Summer Sale",         category: "Social",    format: "Instagram Post", emoji: "🌅", accent: "#f59e0b", prompt: "Vibrant summer sale Instagram post with bold text and warm golden tones, 50% OFF" },
  ...
  { id: "t12", title: "SaaS Pitch Deck",      category: "Brand",     format: "Slide",          emoji: "📱", accent: "#22d3ee", prompt: "Modern SaaS startup pitch deck slide with dark theme, clean layout and blue accents" },
  ...
  { id: "t18", title: "App Store Banner",     category: "Marketing", format: "Banner",         emoji: "📲", accent: "#2DD4BF", prompt: "Clean app store feature banner — iOS style, light layered background, device mockup, bold headline" },
  { id: "t19", title: "LinkedIn Banner",      category: "Brand",     format: "Banner",         emoji: "💼", accent: "#22d3ee", prompt: "Professional LinkedIn profile banner — dark tech backdrop, clean sans-serif, subtle grid" },
