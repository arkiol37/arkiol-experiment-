...
// Vercel route config — up to 50 job creates in transaction
...
const BulkJobItemSchema = z.object({
  ...
  formats:        z.array(
    z.enum(["instagram_post","instagram_story","youtube_thumbnail","flyer","poster","presentation_slide","business_card","resume","logo","facebook_post","twitter_post","display_banner","linkedin_post","tiktok_video"] as const)
  ).min(1).max(9),
