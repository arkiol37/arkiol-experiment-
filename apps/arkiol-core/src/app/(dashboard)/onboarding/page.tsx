...
const PALETTES = [
  ...
  [["#f59e0b", "#ef4444", "#8b5cf6"], "Sunset Red"],
  [["#10b981", "#3b82f6", "#f59e6b"], "Ocean Green"],
  [["#ec4899", "#8b5cf6", "#06b6d4"], "Neon Pink"],
] as const;
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 48, position: "relative" }}>
        ...
        <span style={{ fontWeight: 800, fontSize: 18, letterSpacing: "-0.05em", fontFamily: "var(--font-display)" }}>Arkiol</span>
      </div>
      ...
      {step === 0 && (
        <div className="ak-fade-in" style={card}>
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            <h2 style={{ fontSize: 26, fontWeight: 800, letterSpacing: "-0.04em", margin: "0 0 10px", fontFamily: "var(--font-display)" }}>
              Welcome to Arkiol
            </h2>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 32 }}>
            {ONBOARDING_TIPS.map((tip, i) => (
              <div key={tip.step} style={{
                ...
                <div>
                  <div style={{ fontSize: 13, fontWeight: 700, fontFamily: "var(--font-display)", letterSpacing: "-0.02em", marginBottom: 3 }}>
                    {i + 1}. {tip.step}
                  </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              {PRODUCT_MODES.map(m => (
                <div key={m.id} onClick={() => setMode(m.id)} style={{
                  ...
                  <div style={{ fontSize: 14, fontWeight: 700, fontFamily: "var(--font-display)", letterSpacing: "-0.03em", marginBottom: 4 }}>{m.label}</div>
      ...
      {step === 1 && (
        <div className="ak-fade-in" style={card}>
          <h2 style={{ fontSize: 24, fontWeight: 800, letterSpacing: "-0.04em", margin: "0 0 8px", fontFamily: "var(--font-display)" }}>Brand setup</h2>
      ...
      {step === 2 && (
        <div className="ak-fade-in" style={card}>
          <h2 style={{ fontSize: 24, fontWeight: 800, letterSpacing: "-0.04em", margin: "0 0 8px", fontFamily: "var(--font-display)" }}>
      ...
      {step === 3 && (
        <div className="ak-fade-in" style={{ ...card, textAlign: "center" }}>
          ...
          <h2 style={{ fontSize: 26, fontWeight: 800, letterSpacing: "-0.04em", margin: "0 0 12px", fontFamily: "var(--font-display)" }}>
            You're all set!
          </h2>
