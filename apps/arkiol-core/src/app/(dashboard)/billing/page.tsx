  ...
  return (
    <div style={{ padding: "44px 48px", maxWidth: 1100, margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: 44 }}>
        ...
        <h1 style={{ fontSize: 32, fontWeight: 800, letterSpacing: "-.05em", margin: "0 0 8px", fontFamily: "var(--font-display)" }}>
            ...
            <div
              ...
              style={{
                ...
                boxShadow:     isCurrent
                  ...
                  : plan.popular
                  ? "0 8px 40px rgba(79,70,229,.12), 0 2px 8px rgba(13,17,23,.08)"
                  : "0 2px 10px rgba(0,0,0,.25)",
              }}
            >
              {plan.popular && (
                <div style={{ position: "absolute", top: -12, left: "50%", transform: "translateX(-50%)", background: "#4F46E5", color: "#fff", fontSize: 10, fontWeight: 700, padding: "3px 13px", borderRadius: "var(--radius-full)", letterSpacing: ".07em", textTransform: "uppercase", whiteSpace: "nowrap", boxShadow: "0 2px 10px rgba(79,70,229,.3)" }}>
                  ★ Most Popular
                </div>
              )}
              ...
              <div style={{ display: "flex", alignItems: "flex-end", gap: 3, marginBottom: 3 }}>
                {plan.price === 0 ? (
                  <span style={{ fontSize: 36, fontWeight: 800, letterSpacing: "-.05em", fontFamily: "var(--font-display)", lineHeight: 1, color: "var(--text-primary)" }}>Free</span>
                ) : (
                  <>
                    <span style={{ fontSize: 16, fontWeight: 600, color: "var(--text-muted)", marginBottom: 5 }}>$</span>
                    <span style={{ fontSize: 36, fontWeight: 800, letterSpacing: "-.05em", fontFamily: "var(--font-display)", lineHeight: 1, color: "var(--text-primary)" }}>{plan.price}</span>
              ...
              {plan.key === "FREE" ? (
                ...
                <PaddleCheckout
                  ...
                  style={{
                    ...
                    boxShadow: plan.popular ? "0 4px 14px rgba(79,70,229,.25)" : "none",
                  }}
                />
              ) : (
      ...
      <div style={{ marginBottom: 52 }}>
        <h2 style={{ fontSize: 20, fontWeight: 800, letterSpacing: "-.04em", fontFamily: "var(--font-display)", margin: "0 0 6px" }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
            <thead>
              <tr style={{ background: "var(--bg-elevated)" }}>
                ...
                {(["FREE","CREATOR","PRO","STUDIO"] as const).map((pk, i) => {
                  ...
                  return (
                    <th key={pk} style={{ textAlign: "center", padding: "12px 16px", fontSize: 12, fontWeight: 700, borderBottom: "1px solid var(--border)", background: isCur ? "rgba(79,70,229,.06)" : "transparent", color: isCur ? "var(--accent)" : "var(--text-primary)", borderLeft: i > 0 ? "1px solid var(--border)" : "none" }}>
                      {labels[pk]}
            ...
            <tbody>
              {([
                ...
                <tr key={row.label} style={{ borderBottom: "1px solid var(--border)", background: ri % 2 === 0 ? "transparent" : "rgba(241,245,249,.5)" }}>
                  ...
                  {row.vals.map((v, vi) => {
                    ...
                    const isY = v === "✓", isN = v === "✗";
                    return (
                      <td key={vi} style={{ textAlign: "center", padding: "10px 16px", borderLeft: vi > 0 ? "1px solid var(--border)" : "none", background: isCur ? "rgba(79,70,229,.04)" : "transparent", fontSize: isY || isN ? 15 : 12, fontFamily: isY || isN ? "inherit" : "var(--font-mono)", fontWeight: isCur ? 700 : 400, color: isY ? "var(--success)" : isN ? "var(--border-strong)" : isCur ? "var(--text-primary)" : "var(--text-secondary)" }}>
                        {v}
                      </td>
                    );
                  })}
      ...
      {isPaidPlan ? (
        <div style={{ animation: "fadeUp .5s ease" }}>
          ...
          <div style={{ marginBottom: 22 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 6 }}>
              <h2 style={{ fontSize: 20, fontWeight: 800, letterSpacing: "-.04em", fontFamily: "var(--font-display)", margin: 0 }}>
                Credit Top-ups
              </h2>
            ...
            <p style={{ margin: 0, fontSize: 13, color: "var(--text-secondary)", lineHeight: 1.6 }}>
              ...
              <span style={{ color: "var(--text-muted)", fontSize: 12 }}>
                Top-up rates are higher per-credit than your subscription — subscribe to a higher plan for the best rate.
              </span>
            </p>
          </div>
          ...
          <div style={{ background: "var(--bg-elevated)", border: "1px solid var(--border)", borderRadius: "var(--radius-lg)", padding: "14px 18px", marginBottom: 20, display: "flex", gap: 24, flexWrap: "wrap" }}>
            ...
            {[
              ...
              { label: "200 top-up",  rate: "$0.040", color: "var(--success)", note: "20% cheaper" },
              ...
              <div key={label} style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                <span style={{ fontSize: 15, fontWeight: 800, fontFamily: "var(--font-display)", color, letterSpacing: "-.02em" }}>{rate}</span>
            ...
            {TOPUP_PACKS.map(pack => (
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 4 }}>
                  <span style={{ fontSize: 38, fontWeight: 800, letterSpacing: "-.05em", fontFamily: "var(--font-display)", lineHeight: 1, color: "var(--text-primary)" }}>
                ...
                {/* Price */}
                <div style={{ fontSize: 24, fontWeight: 800, fontFamily: "var(--font-display)", letterSpacing: "-.04em", color: pack.accentColor, marginBottom: 4 }}>
                  ${pack.price}
        ...
        <div style={{ background: "var(--bg-elevated)", border: "1px solid var(--border)", borderRadius: "var(--radius-xl)", padding: "28px 32px", display: "flex", alignItems: "center", gap: 24, animation: "fadeUp .5s ease" }}>
          ...
          <div style={{ flex: 1 }}>
            <h3 style={{ fontSize: 16, fontWeight: 700, fontFamily: "var(--font-display)", margin: "0 0 6px" }}>Need more credits?</h3>
            <p style={{ margin: 0, fontSize: 13, color: "var(--text-secondary)", lineHeight: 1.6 }}>
