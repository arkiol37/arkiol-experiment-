...
// No new auth complexity — shown when /api/billing/status returns canUseStudioVideo=false.
...
const FEATURES = [
  ["◫", "Normal Ads", "Smooth animated ads — 20 credits"],
  ["✦", "Cinematic Ads", "Parallax depth & cinematic lighting — 35 credits"],
  ...
  return (
    <div className="ak-fade-in" style={{ padding: "60px 48px", maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
      ...
      <p style={{ fontSize: 14, color: "var(--text-secondary)", lineHeight: 1.7, marginBottom: 36, maxWidth: 480, margin: "0 auto 36px" }}>
        Generate professional Normal Ads and Cinematic Ads from a single prompt.
