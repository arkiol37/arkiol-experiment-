...
const PROVIDER_INFO: Record<string, ProviderMeta> = {
  ...
  sora: {
    ...
    badge: 'New', badgeColor: '#14B8A6', qualityTier: 'cutting-edge', creditsPerScene: '8–12 cr',
  },
  custom: {
        ...
        {isLoading ? (
          ...
          <div className="p-5 space-y-3">
            {providers.map((p: any) => {
              ...
              return (
                <motion.div
                  ...
                  style={{
                    borderRadius: 14,
                    border: `1px solid ${p.is_primary ? 'rgba(15,118,110,0.35)' : 'rgba(255,255,255,0.08)'}`,
                    background: p.is_primary ? 'rgba(15,118,110,0.04)' : 'rgba(255,255,255,0.025)',
                    overflow: 'hidden',
                  }}
                >
                  {/* Main row */}
                  <div style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '14px 16px' }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 3 }}>
                        ...
                        {p.is_primary && (
                          <span style={{ fontSize: 9, fontWeight: 800, padding: '2px 7px', borderRadius: 99, background: 'rgba(15,118,110,0.2)', color: '#14B8A6', border: '1px solid rgba(15,118,110,0.3)' }}>
                            PRIMARY
                          </span>
                        )}
                        {info.badge && (
                      ...
                      <div style={{ display: 'flex', gap: 12, marginTop: 5 }}>
                        ...
                        {p.cost_optimize && (
                          <span style={{ fontSize: 10.5, color: '#2DD4BF', display: 'flex', alignItems: 'center', gap: 3 }}>
                        ...
                        <div style={{
                          ...
                          {!p.is_primary && (
                            <button
                              ...
                              style={{ color: '#14B8A6', borderColor: 'rgba(15,118,110,0.25)' }}
                            >
                          ...
                          <button
                            ...
                            disabled={updateMutation.isPending}
                            className="btn btn-ghost text-xs"
                            style={{ color: p.cost_optimize ? '#2DD4BF' : 'var(--text-muted)' }}
                          >
            ...
            <button
              ...
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(15,118,110,0.3)'; (e.currentTarget as HTMLElement).style.color = '#14B8A6'; }}
                ...
                {Object.entries(PROVIDER_INFO).map(([k, v]) => (
                  <button
                    ...
                    style={{
                      ...
                      background: newProvider.provider === k ? 'rgba(15,118,110,0.1)' : 'rgba(255,255,255,0.03)',
                      border: `1px solid ${newProvider.provider === k ? 'rgba(15,118,110,0.4)' : 'rgba(255,255,255,0.08)'}`,
                      transition: 'all 0.15s',
                    }}
                  >
