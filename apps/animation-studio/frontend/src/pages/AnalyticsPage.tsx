...
const HOOK_COLORS = ['#14B8A6','#f59e0b','#10b981','#ec4899','#14b8a6','#f97316'];
const DURATION_COLORS = { short: '#10b981', mid: '#f59e0b', long: '#14B8A6' };
            ...
            {isLoading ? <Skeleton /> : (
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={monthlyChart} barCategoryGap="35%">
                  ...
                  <Bar dataKey="renders" name="Renders" fill="#14B8A6" radius={[5, 5, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            )}
          </div>
            ...
            {isLoading ? <Skeleton /> : dailySpendChart.length === 0 ? (
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={dailySpendChart}>
                  ...
                  <YAxis axisLine={false} tickLine={false} tick={{ fill: '#5a5a80', fontSize: 11 }} />
                  <Tooltip {...TOOLTIP_STYLE} />
                  <Area type="monotone" dataKey="credits" name="Credits" stroke="#14B8A6" strokeWidth={2} fill="url(#creditGrad)" dot={false} />
                </AreaChart>
              </ResponsiveContainer>
            )}
          </div>
            ...
            {isLoading ? <Skeleton h="h-40" /> : (
              <div className="space-y-0">
                {[
                  ...
                  ['Render Mode',      data?.preferences?.default_render_mode     ?? 'Normal Ad'],
                  ...
                  >
                    ...
                    <span className="font-bold text-teal-300 text-xs">{v}</span>
                  </div>
                ))}
              </div>
            )}
