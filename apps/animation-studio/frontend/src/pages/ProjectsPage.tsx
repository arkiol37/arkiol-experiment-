                ...
                <div className="p-5 border-b border-white/[0.06] flex items-start justify-between">
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div className="flex items-center gap-2 mb-1">
                      <Film size={14} className="text-gold-400 flex-shrink-0" />
                      ...
                      {[
                        {
                          ...
                          icon: <Film size={11} color="#6366f1" />,
                        },
                        {
                          label: 'Completed',
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        borderColor: isSelected ? 'rgba(232,168,32,0.4)' : undefined,
        background: isSelected ? 'rgba(232,168,32,0.04)' : undefined,
        display: 'flex',
    ...
    >
      <div style={{
        ...
        background: isSelected ? 'rgba(232,168,32,0.2)' : 'rgba(232,168,32,0.1)',
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        marginBottom: compact ? 0 : 14,
      }}>
        <Video size={compact ? 16 : 20} className={isSelected ? 'text-gold-300' : 'text-gold-400'} />
      </div>
      ...
      {isActive && (
        <div style={{ padding: '0 14px 10px' }}>
          ...
          <div style={{ height: 3, borderRadius: 99, background: 'rgba(255,255,255,0.08)' }}>
            <motion.div
              style={{ height: '100%', borderRadius: 99, background: 'linear-gradient(90deg, #6366f1, #f59e0b)' }}
              initial={{ width: 0 }}
      ...
      <div style={{
        ...
        {isFailed && (
          <button onClick={onRetry} disabled={isRetrying}
            style={{ background: 'rgba(99,102,241,0.15)', border: '1px solid rgba(99,102,241,0.3)', color: '#a78bfa', borderRadius: 7, padding: '3px 10px', fontSize: 11, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 4 }}>
