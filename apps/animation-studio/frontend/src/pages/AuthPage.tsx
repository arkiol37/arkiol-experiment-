  ...
  return (
    <div className="min-h-screen bg-ink-900 flex items-center justify-center p-4">
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-teal-600/5 blur-3xl" />
        <div className="absolute top-1/3 -left-40 w-96 h-96 rounded-full bg-teal-900/20 blur-3xl" />
      </div>
      ...
      >
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-teal-600 to-teal-800 text-ink-900 font-black text-2xl mb-4 shadow-teal-lg">
            N
          </div>
