...
const ASSET_TYPE_CONFIG: Record<AssetType, { label: string; icon: React.FC<any>; color: string; bg: string }> = {
  logo:        { label: 'Logo',        icon: Layers,    color: '#2DD4BF', bg: 'rgba(167,139,250,0.12)' },
  ...
  return (
    <div style={{ padding: '36px 44px', maxWidth: 1400, fontFamily: 'var(--font-body)' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 36 }}>
        <div>
          ...
          <p style={{ margin: 0, fontSize: 13.5, color: 'var(--text-secondary)', maxWidth: 480 }}>
            Upload brand assets — logos, products, screenshots, packaging — and AI transforms them into animation-ready ad elements.
          </p>
        </div>
      ...
      <motion.div
        ...
        style={{
          border: `2px dashed ${isDragActive ? '#14B8A6' : 'var(--border-strong)'}`,
          borderRadius: 20, padding: '32px 24px', textAlign: 'center',
          cursor: 'pointer', marginBottom: 28, transition: 'all 0.2s ease',
          background: isDragActive ? 'rgba(15,118,110,0.06)' : 'var(--bg-elevated)',
      ...
      >
        ...
        {isDragActive && (
          <div style={{
            position: 'absolute', inset: 0, background: 'linear-gradient(135deg, rgba(15,118,110,0.08), rgba(139,92,246,0.08))',
            borderRadius: 18,
          }} />
        )}
        <div style={{ position: 'relative' }}>
          <div style={{
            ...
            background: isDragActive ? 'rgba(15,118,110,0.2)' : 'rgba(255,255,255,0.05)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            margin: '0 auto 14px', border: '1px solid var(--border)',
          }}>
            <Upload size={22} color={isDragActive ? '#14B8A6' : 'var(--text-muted)'} />
          </div>
            ...
            {uploads.map(item => (
              ...
              >
                <div style={{
                  ...
                  background: item.status === 'error' ? 'rgba(239,68,68,0.15)' : 'rgba(15,118,110,0.15)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                }}>
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        border: `1px solid ${isSelected ? '#14B8A6' : 'var(--border)'}`,
        borderRadius: 16, overflow: 'hidden', cursor: 'pointer',
        boxShadow: isSelected ? '0 0 0 2px rgba(15,118,110,0.3)' : 'none',
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          border: `2px solid ${isSelected ? '#14B8A6' : 'rgba(255,255,255,0.3)'}`,
          background: isSelected ? '#14B8A6' : 'rgba(0,0,0,0.4)',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          ...
          <div style={{ width: 280, borderLeft: '1px solid var(--border)', padding: 20, overflow: 'auto' }}>
            ...
            {asset.recommendedMotion && (
              <div style={{ marginBottom: 20 }}>
                ...
                <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                  <span style={{ padding: '3px 10px', borderRadius: 99, fontSize: 11, background: 'rgba(15,118,110,0.15)', color: '#2DD4BF' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                {[
                  ...
                  <div key={label} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    {url && (
                      <a href={url} target="_blank" rel="noreferrer" style={{ marginLeft: 'auto', fontSize: 10, color: '#14B8A6', textDecoration: 'none' }}>
                        View
                      </a>
                    )}
                  </div>
