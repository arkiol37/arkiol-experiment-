...
const PLANS = [
  {
    ...
    aiLevel:     'Basic AI',
    aiDesc:      '1 free watermarked Normal Ad per day — no credit required',
    popular:     false,
    accent:      '#9ca3c8',
  ...
  },
  {
    ...
    aiLevel:     'Creative AI',
    aiDesc:      'Full Animation Studio access — Normal & Cinematic Ads, HQ rendering & GIFs',
    popular:     false,
    accent:      '#22d3ee',
  ...
  },
  {
    ...
    aiLevel:     'Advanced AI',
    aiDesc:      'Normal + Cinematic Ads, 4K export, batch generation',
    popular:     true,
    accent:      '#14B8A6',
  ...
  },
  {
    ...
    aiDesc:      'Highest limits, Cinematic Ads, brand kits, team workspace & API',
    popular:     false,
    accent:      '#2DD4BF',
...
const FEATURES: Feature[] = [
  ...
  { label: 'Free watermarked ad (teaser)',       free: true,  creator: false, pro: false, studio: false, category: 'AI Generation' },
  { label: 'Animation Studio — full access',    free: false, creator: true,  pro: true,  studio: true,  category: 'AI Generation' },
  { label: 'Normal Ads — 20 credits',           free: false, creator: true,  pro: true,  studio: true,  category: 'AI Generation' },
  { label: 'Cinematic Ads — 35 credits',      free: false, creator: true,  pro: true,  studio: true,  category: 'AI Generation' },
  ...
  { label: '4K export resolution',              free: false, creator: false, pro: true,  studio: true,  category: 'AI Generation' },
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-10 py-10 max-w-6xl mx-auto">
            ...
            <div
              ...
              style={{
                ...
                background:    plan.popular
                  ? 'radial-gradient(ellipse at top, rgba(15,118,110,0.10) 0%, rgba(11,15,16,0.95) 65%)'
                  : 'rgba(10,10,15,0.70)',
                border:        `1.5px solid ${
                  isCurrent
                    ? plan.accent
                ...
                boxShadow:     plan.popular
                  ? '0 0 0 1px rgba(15,118,110,0.07), 0 12px 48px rgba(15,118,110,0.10), 0 2px 8px rgba(0,0,0,0.5)'
                  : isCurrent
              ...
              {plan.popular && (
                <div
                  style={{
                    ...
                    padding:       '5px 14px',
                    borderRadius:  20,
                    boxShadow:     '0 2px 14px rgba(15,118,110,0.35)',
                  }}
                >
                  ★ Most Popular
                </div>
              ...
              {isCurrent ? (
                ...
                <button
                  ...
                  style={{
                    ...
                    background:    plan.popular
                      ? 'linear-gradient(135deg, #0F766E 0%, #14B8A6 55%, #2DD4BF 100%)'
                      : `${plan.accent}18`,
                    color:         plan.popular ? '#0a0a0f' : plan.accent,
                    boxShadow:     plan.popular ? '0 4px 18px rgba(15,118,110,0.25)' : 'none',
      ...
      <div>
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 13, color: '#66668a' }}>
            Full Animation Studio access on Creator, Pro, and Studio plans. Free plan includes a daily watermarked ad teaser.
          </p>
        </div>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      background: plan.popular ? 'rgba(15,118,110,0.05)' : 'transparent',
                    }}
                  >
                    <div
                      style={{
                        ...
                        fontWeight:    800,
                        letterSpacing: '0.04em',
                        color:         isActive ? plan.accent : plan.popular ? '#14B8A6' : '#8888aa',
                      }}
                    >
                      {plan.name}
                    </div>
                  ...
                  {PLANS.map((plan) => (
                    <div
                      ...
                      style={{
                        ...
                        background: plan.popular ? 'rgba(15,118,110,0.03)' : 'transparent',
                      }}
                    />
                  ))}
                </div>
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            borderLeft:     '1px solid rgba(255,255,255,0.04)',
                            padding:        '11px 0',
                            background:     plan.popular ? 'rgba(15,118,110,0.025)' : 'transparent',
                          }}
                        >
                          {has ? (
                    ...
                    {isCurrent ? (
                      ...
                      <button
                        ...
                        style={{
                          ...
                          background:    plan.popular ? 'linear-gradient(135deg, #0F766E, #14B8A6)' : `${plan.accent}16`,
                          color:         plan.popular ? '#0a0a0f' : plan.accent,
                          cursor:        'pointer',
                          whiteSpace:    'nowrap',
                          opacity:       isLoading ? 0.6 : 1,
      ...
      <p style={{ marginTop: 40, textAlign: 'center', fontSize: 12, color: '#555577', lineHeight: 1.6 }}>
        ...
        <a href="mailto:support@arkiol.com" style={{ color: '#14B8A6', textDecoration: 'none' }}>
